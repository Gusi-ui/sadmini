-- =====================================================
-- CREAR USUARIOS REALES - MANEJO DE REFERENCIAS
-- Elimina referencias y crea usuarios limpios
-- =====================================================

-- 1. Eliminar referencias en workers primero
UPDATE workers SET profile_id = NULL WHERE profile_id IN (
...
-- 8. Eliminar políticas existentes
...
-- 9. Crear políticas de producción correctas
